...
const MATCHES = [
  {
    ...
    batting: [
      ...
      { name: "Dexter Rubles",     runs: null, balls: null, out: "dnb" },
    ...
    bowling: [
      ...
      { name: "Dexter Rubles",     overs: 3, runs: 18, wkts: 2, econ: 6.00 },
    ],
  ...
  },
  {
    ...
    bowling: [
      ...
      { name: "Dexter Rubles",     overs: 3, runs: 11, wkts: 1, econ:  3.67 },
  ...
  },
  {
    ...
    batting: [
      ...
      { name: "Dexter Rubles",     runs: 18, balls: 35, fours: 1, sixes: 0, out: "run out (S Murphy)",  sr:  51.43 },
    ...
    bowling: [
      ...
      { name: "Dexter Rubles",     overs: 2, runs: 13, wkts: 1, econ:  6.50 },
  ...
  },
  {
    ...
    batting: [
      ...
      { name: "Dexter Rubles",     runs:  6, balls: 12, fours: 0, sixes: 0, out: "b A Hussein",                sr:  50.00 },
    ...
    bowling: [
      ...
      { name: "Dexter Rubles",     overs: 2,   runs:  6, wkts: 1, econ: 3.00 },
  ...
  },
  {
    ...
    bowling: [
      ...
      { name: "Dexter Rubles",     overs: 3,   runs: 15, wkts: 2, econ: 5.00 },
