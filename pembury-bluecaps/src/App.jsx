...
const LEAGUE_BATTING = [
  { rank:1,  name:"Jake Nicholson",    games:8, inn:8, no:6, runs:169, hs:"32*", avg:84.50,  sr:125.19 },
  { rank:2,  name:"Caleb Baker-Swain", games:8, inn:8, no:2, runs:163, hs:"50*", avg:27.17,  sr:87.63  },
  { rank:3,  name:"Molly Cairns",      games:7, inn:5, no:4, runs:149, hs:"38*", avg:149.00, sr:96.75  },
  { rank:4,  name:"Sam Brewis",        games:8, inn:8, no:3, runs:138, hs:"31*", avg:27.60,  sr:77.09  },
  { rank:5,  name:"Finn Watson",       games:6, inn:6, no:3, runs:96,  hs:"33*", avg:32.00,  sr:100.00 },
  { rank:6,  name:"Seb Murphy",        games:4, inn:4, no:0, runs:86,  hs:"29",  avg:21.50,  sr:96.15  },
  { rank:7,  name:"Hugo Brown",        games:4, inn:4, no:1, runs:81,  hs:"34",  avg:27.00,  sr:91.46  },
  { rank:8,  name:"Max Chamberlin",    games:4, inn:4, no:2, runs:79,  hs:"32*", avg:39.50,  sr:89.09  },
  { rank:9,  name:"Freddie Hall",      games:7, inn:7, no:2, runs:74,  hs:"33*", avg:14.80,  sr:97.37  },
  { rank:10, name:"Theo Manjrekar",    games:3, inn:3, no:0, runs:71,  hs:"48",  avg:23.67,  sr:74.74  },
];

const LEAGUE_BOWLING = [
  { rank:1,  name:"Caleb Baker-Swain", overs:16.4, runs:54, wkts:10, best:"3/5",  econ:3.24, avg:5.40  },
  { rank:2,  name:"Freddie Hall",      overs:14,   runs:69, wkts:8,  best:"3/5",  econ:4.93, avg:8.63  },
  { rank:3,  name:"Molly Cairns",      overs:13.4, runs:72, wkts:7,  best:"3/6",  econ:5.27, avg:10.29 },
  { rank:4,  name:"Dexter Robles",     overs:18,   runs:91, wkts:7,  best:"2/15", econ:5.06, avg:13.00 },
  { rank:5,  name:"Harry Brown",       overs:13,   runs:69, wkts:6,  best:"2/14", econ:5.31, avg:11.50 },
  { rank:6,  name:"Oliver Curran",     overs:7,    runs:46, wkts:6,  best:"3/18", econ:6.57, avg:7.67  },
  { rank:7,  name:"Charlie Portwood",  overs:10,   runs:43, wkts:6,  best:"3/13", econ:4.30, avg:7.17  },
  { rank:8,  name:"Freddie Drew",      overs:9,    runs:54, wkts:5,  best:"2/8",  econ:6.00, avg:10.80 },
  { rank:9,  name:"Shreyan Guha",      overs:8,    runs:44, wkts:5,  best:"3/16", econ:5.50, avg:8.80  },
  { rank:10, name:"Reyansh Gupta",     overs:12.2, runs:67, wkts:5,  best:"2/14", econ:5.43, avg:13.40 },
];

const LEAGUE_FIELDING = [
  { rank:1,  name:"Sam Brewis",          wkCatches:5, stumpings:8, wkWkts:13, fldCatches:0, runOuts:2, totalFld:2, totalCatches:5,  totalVictims:15 },
  { rank:2,  name:"Caleb Baker-Swain",   wkCatches:0, stumpings:0, wkWkts:0,  fldCatches:1, runOuts:2, totalFld:3, totalCatches:1,  totalVictims:3  },
  { rank:3,  name:"Evo Boscowen",        wkCatches:0, stumpings:0, wkWkts:0,  fldCatches:3, runOuts:0, totalFld:3, totalCatches:3,  totalVictims:3  },
  { rank:4,  name:"Benjamin Daplyn",     wkCatches:0, stumpings:1, wkWkts:1,  fldCatches:1, runOuts:1, totalFld:2, totalCatches:1,  totalVictims:3  },
  { rank:5,  name:"Seb Murphy",          wkCatches:0, stumpings:0, wkWkts:0,  fldCatches:1, runOuts:2, totalFld:3, totalCatches:1,  totalVictims:3  },
  { rank:6,  name:"Bailey Osman",        wkCatches:0, stumpings:0, wkWkts:0,  fldCatches:1, runOuts:2, totalFld:3, totalCatches:1,  totalVictims:3  },
  { rank:7,  name:"Dexter Robles",       wkCatches:0, stumpings:0, wkWkts:0,  fldCatches:2, runOuts:1, totalFld:3, totalCatches:2,  totalVictims:3  },
  { rank:8,  name:"George Bathurst-Taylor", wkCatches:1, stumpings:0, wkWkts:1, fldCatches:0, runOuts:1, totalFld:1, totalCatches:1, totalVictims:2 },
  { rank:9,  name:"Freddie Hall",        wkCatches:0, stumpings:0, wkWkts:0,  fldCatches:2, runOuts:0, totalFld:2, totalCatches:2,  totalVictims:2  },
  { rank:10, name:"Shreyas Kambrath",    wkCatches:1, stumpings:0, wkWkts:1,  fldCatches:1, runOuts:0, totalFld:1, totalCatches:2,  totalVictims:2  },
];
